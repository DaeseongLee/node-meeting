        ...
        <>
            <header className="text-gray-100 bg-gray-900 body-font shadow w-full rounded-xl">
                <div className="container mx-auto p-5 flex justify-around ">
                    <nav className="flex w-full  items-center text-base rounded-xl">
                        <Link href=""><a className="headerLink">모임's <SearchIcon className="headerIcon" /></a></Link>
                        <Link href=""><a className="headerLink">내 모임<IdentificationIcon className="headerIcon" /></a></Link>
                        <Link href=""><a className="headerLink">더보기 <DotsHorizontalIcon className="headerIcon" /></a></Link>
                    </nav>
